...
2. The greatest economic consequences have been due to the following weather events: **a. Property costs**: *Flood (144B), Hurrican/Thyphoon (69B), Tornado (56B)*, **b. Crop costs**: *Drought (13.9B USD), Flood (5.7B USD), River Flood (5B USD)*

For further details, check out the complete report here attached. In order to reproduce completely this analysis, you can find all kind of information and the R code in this [git repository]().
